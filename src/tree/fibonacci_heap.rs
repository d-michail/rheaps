...
impl<K: Ord, V> DecreaseKeyHeap<K, V> for FibonacciHeap<K, V> {
...
crate::impl_heap_via_addressable!(FibonacciHeap);
crate::impl_meldable_heap_via_addressable!(FibonacciHeap);
