...
impl<K: Ord, V> DecreaseKeyHeap<K, V> for BinaryTreeAddressableHeap<K, V> {
...
impl<K: Ord> BinaryTreeAddressableHeap<K, ()> {
...
crate::impl_heap_via_addressable!(BinaryTreeAddressableHeap);
